...
def available_aircraft_at_airport(
    ...
    return {"aircraft": svc.aircraft_repo.availabe_aircraft_by_airport(airport_code)}
...
def launch_flight(
    flight_id: UUID, svc: FlightOperationService = Depends(get_flight_operation_service)
):
